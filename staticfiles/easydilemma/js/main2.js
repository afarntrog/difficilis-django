...
var form_1_reason_element = '<div class="form-row">'
    ...
    +'<div class="col-md-4">'
    +    '<div class="input-group mb-3">'
    +        '<select name="form-first-half-select" class="browser-default custom-select" required>'
...
var form_2_reason_element = '<div class="form-row">'
    ...
    +'<div class="col-md-4">'
    +    '<div class="input-group mb-3">'
    +        '<select name="form-second-half-select" class="browser-default custom-select" required>'
    +            '<option value="">Select Importance...</option>'
    +            '<option value="1">Not really important</option>'
    +            '<option value="2">Somewhat Important</option>'
    +            '<option value="3">Important</option>'
